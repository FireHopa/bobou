    ...
    <div className="auth-page-shell flex min-h-screen items-center justify-center overflow-hidden p-4">
      ...
      <div className="auth-page-card w-full max-w-md overflow-hidden rounded-[2rem] border p-7 shadow-2xl sm:p-8">
        ...
        <div className="mb-7 text-center">
          ...
          <h2 className="auth-page-title text-3xl font-bold text-white">Entrar na plataforma</h2>
          <p className="auth-page-muted mt-2 text-sm text-zinc-400">Acesse seus agentes, projetos e publicações.</p>
        </div>
        ...
        <div className="auth-page-muted my-6 flex items-center text-zinc-500">
          <div className="auth-page-divider flex-1 border-t border-zinc-700" />
        ...
        <button
          ...
          disabled={loading}
          className="auth-page-google-button flex w-full items-center justify-center gap-2 rounded-2xl border border-zinc-700 bg-zinc-800 p-3.5 font-medium text-white transition hover:bg-zinc-700 disabled:cursor-not-allowed disabled:opacity-60"
        >
        ...
        <p className="auth-page-muted mt-6 text-center text-sm text-zinc-400">
          Ainda não tem conta? <Link to="/register" className="auth-page-link font-semibold text-blue-500 hover:underline">Criar conta</Link>
        </p>
      </div>
    </div>
  );
